...
clientSource = $(dir)/client.c $(dir)/mainTools.c $(dir)/clientTools.c $(dir)/tools.c $(dir)/socketPool.c $(dir)/syncWraps.c $(dir)/dirTools.c
clientAll = $(clientSource) $(dir)/mainTools.h $(dir)/clientTools.h $(dir)/tools.h $(dir)/socketPool.h $(dir)/syncWraps.h $(dir)/dirTools.h
